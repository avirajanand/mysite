...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('form#change-email').validate({
                    ...
                    messages: {
                        new_email: {
                            required: '?php echo osc_esc_js(__("Email: this field is required", "paris")); ?>.',
                            email: '<?php echo osc_esc_js(__("Invalid email address", "paris")); ?>.'
                        }
                    },
  ...
  <div class="panel-heading">
                <h1><?php _e('Change your e-mail', 'paris'); ?></h1></div>
                ...
                <form id="change-email" action="<?php echo osc_base_url(true); ?>" method="post">
                    ...
                    <fieldset>
                        <div class="form-group">
                            <label class="control-label" for="email"><?php _e('Current e-mail', 'paris'); ?></label>
                            <span><?php echo osc_logged_user_email(); ?></span>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="new_email"><?php _e('New e-mail', 'paris'); ?> *</label>

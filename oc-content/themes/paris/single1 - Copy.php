...
<meta property="og:description"        content="<?php echo osc_item_description(); ?>" />
...
<!--<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a id="item_offensive" href="<?php echo osc_item_link_offensive(); ?>" rel="nofollow"><?php _e('offensive', 'paris'); ?></a></li>
              ...
              <button style="margin-left:5px" class="btn"><div class="fb-send" data-href="<?php echo osc_item_url( ); ?>">
			     </div></button>
                        </p>
                    <?php }; ?>
                </div>

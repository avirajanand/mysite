<?php
     ...
     */
?>
<div class="container"><div class="ari"><h2><?php _e('Special Items', 'paris') ; ?></h2></div>
          <div class="row">
            

              <div id="owl-demo" class="owl-carousel">
<?php
    osc_get_premiums($max = 8) ;
...
<a href="<?php echo osc_premium_url() ; ?>"><img src="<?php echo osc_resource_thumbnail_url() ; ?>" alt="<?php echo osc_premium_title(); ?>"></a>

...
<li class="dropdown">
          ...
          <li><a href="<?php echo osc_user_profile_url() ; ?>"><span class="fa fa-user" aria-hidden="true"></span> <?php _e('My account', 'paris') ; ?></a></li>
           ...
           <li><a href="<?php echo osc_user_alerts_url() ; ?>"><span class="fa fa-warning-sign" aria-hidden="true"></span> <?php _e('Manage your alerts', 'paris') ; ?></a></li>
...
<input type="text" name="sPattern"  class="form-control" placeholder="<?php echo osc_esc_html( osc_get_preference('keyword_placeholder', 'paris') ); ?>" value=""/>
      ...
      <span class="input-group-btn">
        <button type="submit" class="btn btn-default" type="button"><?php _e('Search', 'paris'); ?></button>
      </span>
    <div>
    </fieldset>
</form>

...
<div class="container">
	<div class="row container ulfa">
<div class="col-md-6">
<div class="panel panel-default">
<div class="panel-heading">Premium Items</div>
...
<?php if( osc_count_premium_resources() ) { ?>
	        			...
	        			<a class="pull-left" href="<?php echo osc_premium_url() ; ?>" title="<?php echo osc_premium_title(); ?>"><img class="media-object" src="<?php echo osc_resource_thumbnail_url() ; ?>" title="" alt="<?php echo osc_premium_title(); ?>" style="width: 64px; height: 64px;"></a>
